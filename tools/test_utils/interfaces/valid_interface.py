...
class ValidDriver(metaclass=MultipleMeta):
    def __init__(self, clk:ValueObjectBase, data:ValueObjectBase, valid: ValueObjectBase, name:str="valid_driver"):
        self.clk = clk
        self.data = data
        self.valid = valid
        self.name = name
...
class ValidMonitor(metaclass=MultipleMeta):
    def __init__(self, clk:ValueObjectBase, data:ValueObjectBase, valid: ValueObjectBase, name:str="valid_monitor"):
        self.clk = clk
        self.data = data
        self.valid = valid
        self.name = name    
