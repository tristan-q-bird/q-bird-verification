...
class DataDriver(metaclass=MultipleMeta):
    def __init__(self, clk:ValueObjectBase, data:ValueObjectBase, name:str="data_driver"):
        self.clk = clk
        self.data = data
        self.name = name
...
class DataMonitor(metaclass=MultipleMeta):
    def __init__(self, clk:ValueObjectBase, data:ValueObjectBase, name:str="data_monitor"):
        self.clk = clk
        self.data = data
        self.name = name    
